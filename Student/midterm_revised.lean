...
-- | r0, b, c => match b with
--   | r0 => match c with
--   -- was supposed to write 27 of these lines
--     | r0 => [r0 + r0 + r0 = r0 + (r0 + r0)]
--     | r120 => [r120 + r120 + r120 = r120 + (r120 + r120)]
--     | r240 => [r240 + r240 + r240 = r240 + (r240 + r240)]
-- | r120, b, c =>
-- | r240, b, c => _
...
-- this will be due the Wednesday after break
/-
  Steps for making an instance of AddMonoid for Rotation:
    1. Define AddSemiGroup
      instance : AddSemigroup Rotation := { add_assoc := sorry }
    2. Define Zero for rotation
      For SubNegMonoid, do I have to define neg?
    3. Define add function
      def add_Rotations : Rotation → Rotation → Rotation
      | r0, r => r        -- r matches any argument value
      | r, r0 => r        -- r matches any argument value
      | r120, r120 => r240
      ...
      | r240, r120 => r0
      | r240, r240 => r120
      equivalent is probably sub_State
    4. Instantiate add function for Rotation
      instance : Add Rotation := { add := add_Rotations }   -- using {} notation

-/

-- need to instantiate some typeclasses

-- In this case G is Rotation
--(zero_add : ∀ (a : M), 0 + a = a)
-- (add_zero : ∀ (a : M), a + 0 = a)
